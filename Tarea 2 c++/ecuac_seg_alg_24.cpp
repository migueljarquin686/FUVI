// Autor Miguel Flores
//24. Algoritmo que nos calcule las raíces de una ecuación de segundo grado.
...
int main() {
	...
	float x1;
	float x2;
	cout << "Este algorimo te calcula las raices cuadradas de una ecuacion de segundo grado, que lo disfrutes." << endl;
