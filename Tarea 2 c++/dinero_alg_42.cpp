...
int main() {
	...
	float cm1;
	do {
		cout << "Este algoritmo te calcula dinero expresado en billetes y monedas en circulacion, que lo disfrute." << endl;
		cout << "Por favor ingrese cantidades que terminen en ceros" << endl;
