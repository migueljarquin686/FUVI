...
int main() {
	...
	float sn;
	float st;
cout  << "Este algoritmo te calcula el salario neto de una semana de acuerdo a los datos que te pide, que lo disfrutes." << endl;
	cout << "Ingrese el nombre del empleado" << endl;
	cin >> nombre;
	cout << "Ingrese su salario basico por hora" << endl;
	cin >> sh;
	cout << "Ingrese el numero de horas trabajadas en todo el dia" << endl;
	cin >> nh;
